...
@section('content')
    ...
    <div class="content"><div class="ic"></div>
        <div class="container">
            <div class="col-lg-12">
                <h2 class="center">Ближайшее мероприятие</h2>
            ...
            <div class="col-lg-4">
                <div class="box">
                    <div class="box_title">Календарь</div>
                    <div class="box_bot">
                        <div class="maxheight">
                            <img src="/images/page1_img1.jpg" alt=""><a href="#">Подробнее</a>
                        </div>
                    </div>
                </div>
            </div>
            <div class="col-lg-4">
                <div class="box">
                    <div class="box_title">Участники</div>
                    <div class="box_bot">
                        <div class="maxheight">
                            <img src="/images/page1_img2.jpg" alt=""><a href="#">Подробнее</a>
                        </div>
                    </div>
                </div>
            </div>
            <div class="col-lg-4">
                <div class="box">
                    <div class="box_title">Результаты</div>
                    <div class="box_bot">
                        <div class="maxheight">
                            <img src="/images/page1_img3.jpg" alt=""><a href="#">Подробнее</a>
                        </div>
                    </div>
                </div>
            </div>
